...
if (file_exists('class/award_class.php')) {
...
</svg> Add Award <i class="bi bi-plus-circle"></i>
                        ...
                        <div class="card-body">
                            ...
                            <table id="example" class="table table-striped table-bordered">                  
                                ...
                                ?>
                                            ...
                                            <tr>
                                                <td><?php echo $i++ ?> </td>
                                                 <td> <img src = "uploads/award_images/<?php echo $data['imagelist']; ?>" width = "56px"
                                                height= "50px"> </td>
                                                <td><?php echo $data['name'] ?> </td>
                                                <td><?php echo $data['award_type'] ?> </td>
                                                ...
                                                <a href="edit_award.php?id=<?php echo $data['id'] ?>" class="edit_class"><button class="btn edit" style="background-color: #68cf29;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
