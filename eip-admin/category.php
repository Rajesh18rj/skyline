...
if (file_exists('class/category_class.php')) {
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="category.php" class="color_class">Category</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
</svg>  <i class="bi bi-plus-circle"></i>  Add Category </button>
                </a>
                            ...
                            <table  id="example" class="table table-striped table-bordered">                  
                                ...
                                ?>
                                            ...
                                            <tr>
                                                ...
                                                <a href="edit_category.php?id=<?php echo $data['id'] ?>" class="edit_class">
