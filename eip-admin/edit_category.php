...
if (isset($_POST['submit'])) { 
    extract($_POST); 
    if(isset($cate_name)){
        $datas = $cate->update_category($cate_name,$active,$id);
        if ($datas['status']) {
...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="category.php" class="color_class">Add Category</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                                ...
                                <div class="row">
                                    ...
                                    <!-- text input -->
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter the Category Name" name="cate_name" id="cate_name" value="<?php echo $data["category_name"]; ?>" required>
                                        </div>
                                    </div>  
  ...
  <path d="M2 1a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H9.5a1 1 0 0 0-1 1v7.293l2.646-2.647a.5.5 0 0 1 .708.708l-3.5 3.5a.5.5 0 0 1-.708 0l-3.5-3.5a.5.5 0 1 1 .708-.708L7.5 9.293V2a2 2 0 0 1 2-2H14a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h2.5a.5.5 0 0 1 0 1z"/>
                          ...
                          Update</button>
                          <a href="category.php" class="btn btn-secondary a-btn-slide-text">
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708"/>
                          ...
                          <a href="category.php?id=<?php echo $data['id'] ?>&&delete=delete" id="delete" class="btn btn-danger a-btn-slide-text">
