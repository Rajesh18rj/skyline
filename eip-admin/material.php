...
if (file_exists('class/material_class.php')) {
...
</svg>  <i class="bi bi-plus-circle"></i> Add Material </button>
                </a>
                            ...
                            <table id="example" class="table table-striped table-bordered">                  
                                ...
                                ?>
                                            ...
                                            <tr>
                                                ...
                                                <a href="edit_material.php?id=<?php echo $data['id'] ?>" class="edit_class">
