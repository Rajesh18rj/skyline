...
if (isset($_POST['submit'])) { 
    extract($_POST);   
      $login = $user->reg_user($username, $password, $user_role);
      if ($login) {
...
<head>
  ...
  <title>Register in | Scientific International Publishing House</title>
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="" method="post" name="register">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Role" name="user_role" required>
          <div class="input-group-append input-group-text">
              <span class="fas fa-user"></span>
          </div>
        </div>
        ...
        <button type="button" id="togglePassword" class="toggle-password input-group-append input-group-text">
            <i class="fa fa-eye"></i>
        </button>
        </div>
        <div class="input-group mb-3">
        <input type="password" id="passwordcon" class=" form-control password-input" placeholder="Confirm Password" required>
        <button type="button" id="togglePasswordcon" class="toggle-password input-group-append input-group-text">
            <i class="fa fa-eye"></i>
        </button>
        </div>
        <div class="row">
          <div class="col-12">
            <button type="submit" class="btn btn-dark btn-block btn-flat" id="submit" name="submit">Register</button>
          </div> 
          <!-- /.col -->
        </div>
...
<script type="text/javascript">
  ...
  $('.btn-del').on('click', function(e){
    ...
    document.getElementById('togglePassword').addEventListener('click', function (e) {
        ...
        document.getElementById('togglePasswordcon').addEventListener('click', function (e) {
            // Toggle the type attribute
            //alert("hello");
